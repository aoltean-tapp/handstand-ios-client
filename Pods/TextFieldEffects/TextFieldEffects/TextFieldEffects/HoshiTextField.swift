...
@IBDesignable open class HoshiTextField: TextFieldEffects {
    ...
    */
    ...
    private let textFieldInsets = CGPoint(x: 4, y: 12)
    ...
    private func layoutPlaceholderInTextRect() {        
        ...
        let finalPlaceholderY = (textRect.height - (((self.text?.count)!>0 || isEditing) ? 0 : placeholderLabel.frame.height))/2

        placeholderLabel.frame = CGRect(x: originX, y: finalPlaceholderY,
