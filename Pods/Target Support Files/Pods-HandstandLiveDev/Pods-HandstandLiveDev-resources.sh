...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/Kahuna/KahunaInAppMessageView.h"
  install_resource "${PODS_ROOT}/Kahuna/KahunaInAppMessageView.m"
  install_resource "${PODS_ROOT}/Kahuna/README"
  install_resource "${PODS_ROOT}/Kahuna/CHANGELOG"
