...
public class HSOriginalTrainerDetails {
    ...
    private let kHSOriginalTrainerDetailsTrainerColorKey: String = "color"
    ...
    public init(json: JSON) {
        ...
        color = json[kHSOriginalTrainerDetailsTrainerColorKey].string
    }
    ...
    public func dictionaryRepresentation() -> [String: Any] {
        ...
        if let value = color {dictionary[kHSOriginalTrainerDetailsTrainerColorKey] = value}
        return dictionary
    }
