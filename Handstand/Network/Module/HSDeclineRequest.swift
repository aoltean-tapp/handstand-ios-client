...
public class HSDeclineRequest {
    ...
    private let kHSDeclineRequestColorKey: String = "color"
    ...
    public init(json: JSON) {
        ...
        color = json[kHSDeclineRequestColorKey].string
    }
    ...
    public func dictionaryRepresentation() -> [String: Any] {
        ...
        if let value = color {dictionary[kHSDeclineRequestColorKey] = value}
        return dictionary
    }
}
