...
open class BMPlayer: UIView {
    ...
    var customControllView: BMPlayerCustomControlView?
    ...
    fileprivate func initUI() {
        ...
        if let customView = customControllView {
            ...
            self.customControllView = controlView
        }
    ...
    fileprivate func preparePlayer() {
        ...
        playerLayer?.isBackgroundPlayback = isBackgroundPlayback
        playerLayer?.audioTitle = audioTitle
