...
static NSString* const KAHUNA_PUSH_MEDIA_ATTACHMENT = @"media_attachment";
static NSString* const KAHUNA_CREDENTIAL_MOBILE_NUMBER = @"mobile_number";
...
- (void) kahunaPushMessageReceived: (NSString *) message title: (NSString *)title withDictionary: (NSDictionary *) extras withApplicationState:(UIApplicationState) applicationState;
- (void) kahunaInAppMessageReceived: (NSString *) message withDictionary: (NSDictionary *) extras;
- (void) kahunaSdkTemplateInAppMessageReceived;
@end
 ...
 */
+ (void)loginWithCredentials:(KahunaUserCredentials *)kahCredentials error:(NSError *__autoreleasing *)error;
...
/*!
 ...
 @abstract
 This API is used to notify the SDK to display an available SDK Marketer Friendly InApp Message
 
 @discussion
 This API is used to notify the SDK to display an available SDK Marketer Friendly InApp Message
 */
+ (void) displayPendingSdkTemplateInAppMessage;
...
/*!
 ...
 @abstract
 This API is used to set the UNUserNotificationCenter delegate
 
 @discussion
 This API is used to allow Kahuna SDK to hook into the new iOS 10 UserNotification Framework for push message and local notification tracking. This should only be used if the app's UNUserNotificationCenter delegate needs to be set BEFORE the KahunaSDK has been initialized
 
 */
+ (void) setUserNotificationCenterDelegate:(id)delegate;
