...
class HSMainViewController: HSBaseController, HSSubcriptionControllerDelegate, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(HSMainViewController.pushWorkoutScreen), name: NSNotification.Name(rawValue: "Notification.showMyWorkout"), object: nil)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(HSMainViewController.showBookSession), name: NSNotification.Name(rawValue: "Notification.findTrainer"), object: nil)
