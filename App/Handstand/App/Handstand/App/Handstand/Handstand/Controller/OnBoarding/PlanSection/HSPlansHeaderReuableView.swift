...
protocol HSPlansHeaderViewProtocol:class {
    func didTapContentOnlyButton()
    func didTapInPersonTrainingOnly()
    func didTapContentNInPersonTraining()
}

class HSPlansHeaderView: UIView {
    ...
    @IBOutlet weak var contentNinPersonTrainingTopBGView: UIView!
    ...
    public func populatePlansInfo(plan:HSGetPlanListResponse) {
        ...
        //Primary focus to 0th
        didTapContentOnlyButton(self)
        //contentOnly
    ...
    private func contentNInPersonTrainingSelected(isSelected:Bool) {
        ...
        contentNinPersonTrainingTopBGView.backgroundColor = isSelected ? UIColor.handstandGreen() : UIColor.rgb(0x8E8E93)
    }
    ...
    @IBAction func didTapContentOnlyButton(_ sender: Any) {
        ...
        self.delegate?.didTapContentOnlyButton()
    }
    ...
    @IBAction func didTapInPersonTrainingOnly(_ sender: Any) {
        ...
        self.delegate?.didTapInPersonTrainingOnly()
    }
    ...
    @IBAction func didTapContentNInPersonTraining(_ sender: Any) {
        ...
        self.delegate?.didTapContentNInPersonTraining()
    }
