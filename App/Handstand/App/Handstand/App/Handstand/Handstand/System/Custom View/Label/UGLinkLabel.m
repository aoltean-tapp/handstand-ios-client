...
//        NSLog(@"Chunk:{%@}", chunk);
        ...
        if (isLink)
        {
            label.textColor = [UIColor colorWithRed:24/255.0f green:114/255.0f blue:255/255.0f alpha:1.0];
            //            label.highlightedTextColor = [UIColor yellowColor];
            
            // 5. Set tap gesture for this clickable text:
            UGTapGestureRecognizer *tapGesture = [[UGTapGestureRecognizer alloc] initWithTarget:self
                                                                                         action:@selector(onLinkAction:)];
